...
function Page() {
  return (
    <div class="padded-content">
      ...
      <section>
        <h2>COVID</h2>
        <p>This is what it will look like empus.</p>
      </section>
      <section>
        ...
        <p>
          ...
          particular recommendations for places to stay but this guide to
      ...
      <section>
        ...
        <p>
          ...
          Central Railway Station (pick up time FILL IN); and Johnsonville
          Railway Station (pick up time FILL IN) At the end of the evening,
          buses will be leaving Boomrock to return guests to Wellington at two
          different times [what are these times?]
        </p>
      </section>
      <section>
        <h2>Childcare</h2>
